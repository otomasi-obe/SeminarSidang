...
CREATE TABLE schedules (
    ...
    -- Status
    status VARCHAR(50) DEFAULT 'DIJADWALKAN',  -- DIJADWALKAN, BERLANGSUNG, SELESAI, DITUNDA, BATAL, SUBMITTED_TO_PRODI, EXAMINERS_ASSIGNED, SCHEDULED, INVITATION_SENT, START_EXAM, COMPLETED
    catatan TEXT,
